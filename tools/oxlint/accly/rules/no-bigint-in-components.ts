...
export const noBigintInComponentsRule = defineRule({
  meta: {
    ...
    messages: {
      bigintLiteral:
        "No bigint literals in a .tsx file: the React Compiler rewrites them to `undefined` inside a compiled component. Move the amount into the money module and call a helper (ZERO_MONEY, isZeroMoney, absMoney, debitOf, creditOf).",
    },
  },
  createOnce(context) {
    return {

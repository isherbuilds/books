...
CREATE TABLE "tds_deductions" (
	...
	CONSTRAINT "tds_deductions_base_paise_check" CHECK ("tds_deductions"."base_paise" > 0),
...
CREATE TABLE "document_lines" (
	...
	CONSTRAINT "document_lines_discount_paise_check" CHECK ("document_lines"."discount_paise" >= 0)
);
--> statement-breakpoint
...
CREATE TABLE "documents" (
	...
	CONSTRAINT "documents_supply_type_check" CHECK ("documents"."type" not in ('invoice', 'bill', 'creditNote', 'debitNote') or "documents"."intra_state" is not null),
	...
	CONSTRAINT "documents_discount_paise_check" CHECK ("documents"."discount_paise" >= 0)
);
--> statement-breakpoint
CREATE TABLE "organization_settings" (
	...
	"debit_note_prefix" text NOT NULL,
...
ALTER TABLE "documents" ADD CONSTRAINT "documents_org_id_amended_from_id_documents_org_id_id_fk" FOREIGN KEY ("org_id","amended_from_id") REFERENCES "public"."documents"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "documents" ADD CONSTRAINT "documents_org_id_against_document_id_documents_org_id_id_fk" FOREIGN KEY ("org_id","against_document_id") REFERENCES "public"."documents"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

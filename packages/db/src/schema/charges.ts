...
import { ITEM_CATEGORIES, items } from "./items";
...
// later item changes never alter existing care.
export const charges = pgTable(
  "charges",
  {
    ...
    revenueCategory: text("revenue_category", { enum: ITEM_CATEGORIES }).notNull(),
  ...
  (table) => [
    ...
    check("charges_source_type_check", sql`${table.sourceType} in ('consult_fee', 'item')`),

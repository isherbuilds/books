...
import {
  ...
  customerAgeLabel,
  customerAgeYears,
} from "../../apps/web/src/lib/customer-age";
...
test("calendar age and estimate labels use date strings without timezone conversion", () => {
  expect(customerAgeYears("1992-08-28", "2026-08-27")).toBe(33);
  expect(customerAgeYears("1992-08-27", "2026-08-27")).toBe(34);
  expect(customerAgeLabel("1992-08-27", false, "2026-08-27")).toBe("34");
  expect(customerAgeLabel("1992-08-27", true, "2026-08-27")).toBe("~34");
});

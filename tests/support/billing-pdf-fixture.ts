...
export function billingPdfFixture({
  ...
  return {
    invoice: {
      ...
      taxTotal: tax,
      grandTotal: total,
      orgLegalName: unicode ? "आरोग्य क्लिनिक" : "Accly Books Clinic",
      orgAddress: unicode ? "पुणे, महाराष्ट्र" : "Pune, Maharashtra",
      orgTaxId: "27ABCDE1234F1Z5",
      currency: "INR",
      customerName: unicode ? "कविता शर्मा" : "Kavita Sharma",
      customerCode: "Code-0001",
      customerPhone: "+919876543210",
      customerAddress: unicode ? "शिवाजी नगर, पुणे" : "Shivaji Nagar, Pune",
      issuedBy: "user-1",

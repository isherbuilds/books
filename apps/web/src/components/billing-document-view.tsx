...
// for, so a re-print can be checked against the customer in front of the counter
...
// customer is handed are the same bytes.
//
...
function BillingDocumentView({
  ...
  const customer = invoice.data?.invoice;
    ...
    <>
      <div className="contents lg:hidden">
        <PageHeader
          ...
          description={customer && `${customer.customerName} · Code ${customer.customerCode}`}
        />
      </div>

  ...
  return (
    <div className="min-h-svh overflow-x-clip bg-background text-foreground">
      ...
      <main id="main" tabIndex={-1} className="flex flex-col">
        <article className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 pt-16 sm:px-6 sm:pt-24">
...
export const PROSE =
  "flex flex-col gap-4 text-base text-pretty [&_h2]:text-2xl [&_h2]:font-medium [&_h2]:tracking-tight [&_h3]:text-xl [&_h3]:font-medium [&_h3]:tracking-tight [&_p]:text-muted-foreground [&_li]:text-muted-foreground [&_ul]:flex [&_ul]:flex-col [&_ul]:gap-2 [&_ul]:pl-4 [&_ul]:list-disc [&_ol]:flex [&_ol]:flex-col [&_ol]:gap-2 [&_ol]:pl-4 [&_ol]:list-decimal [&_strong]:font-medium [&_strong]:text-foreground [&_a]:underline [&_a]:underline-offset-4 [&_em]:italic";

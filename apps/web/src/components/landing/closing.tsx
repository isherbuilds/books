...
/* The page's ending: the final ask on the same washed stage the hero opens with,
   ...
   exactly how an unfinished compliance claim should read here. */
...
/* Stated, not implied. A badge that says "not yet" is worth more here than a row
   of marks we do not hold — and the e-invoicing answer in the FAQ says the same
   thing, so the page cannot contradict itself. */
const BADGES: { label: string; state: "held" | "pending" }[] = [
  ...
  { label: "E-invoicing (IRP) — not yet supported", state: "pending" },
];

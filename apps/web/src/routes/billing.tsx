...
export const Route = createFileRoute("/billing")({
  ...
  component: () => (
    <FeaturePage
      shot="billing"
      eyebrow="Invoicing, payments and GST"
      title="Know what you are owed"
      lead="Unbilled work, unpaid invoices and refunds due, on one screen."
      windowTitle="Billing · Meridian Traders"
      ...
      crops={[
        {
          ...
          body: "Waiting to be billed, collected, outstanding and over 30 days — the whole day before anyone opens a report.",
        },
        {
          region: { x: 272, y: 210, w: 740, h: 330 },
          claim: "The open money, filtered in one click.",
          body: "To bill, unpaid, or over seven days. Search by customer, code or invoice number without leaving the list.",
        },
        {

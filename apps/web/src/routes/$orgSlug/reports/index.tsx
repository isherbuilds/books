    ...
    <>
      ...
      <PageBody>
        <p className="text-muted-foreground">
          These reports cover transactions recorded in this Accly Books. Opening balances,
          non-billing activity, and final accounts remain in the accountant's books.
        </p>

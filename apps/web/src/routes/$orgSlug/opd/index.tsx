...
export const Route = createFileRoute("/$orgSlug/opd/")({
  head: () => ({ meta: [{ title: "Outpatient · Accly Books" }] }),
                  ...
                  <TableRow key={appointment.id}>
                    ...
                    <TableCell className="max-w-0">
                      <Link
                        ...
                        title={
                          appointment.customerName ?? appointment.callerName ?? "Unnamed caller"
                        }
                      ...
                      <p
                        ...
                        title={appointment.customerCode ?? appointment.callerPhone ?? "No phone"}
                      >
                        {appointment.customerCode ?? appointment.callerPhone ?? "No phone"}
                      </p>
                    </TableCell>
              ...
              <li key={appointment.id} className="border-b text-xs">
                <div className="flex min-w-0 items-start">
                  <Link
                    to="/$orgSlug/opd/$appointmentId"
                    params={{ orgSlug, appointmentId: appointment.id }}
                    title={appointment.customerName ?? appointment.callerName ?? "Unnamed caller"}
    ...
    <PageBody>
      <ListToolbar>
        <SearchInput
          ...
          placeholder="Search name, code, phone or token"

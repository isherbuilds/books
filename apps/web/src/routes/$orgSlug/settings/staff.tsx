...
export const Route = createFileRoute("/$orgSlug/settings/staff")({
  head: () => ({ meta: [{ title: "Staff · Accly Books" }] }),
                  ...
                  <TableRow key={department.id}>
                    ...
                    <TableCell>
                      {department.defaultConsultFeeItemId
                        ? (itemById.get(department.defaultConsultFeeItemId)?.name ?? "—")
                        : "—"}
                    </TableCell>
            ...
            <ListState
              ...
              empty={
                query
                  ...
                  : "No practitioners yet. Add the clinicians a customer can be booked with."
              }
            >
              <Table>
                <TableHeader>
                      ...
                      <TableRow key={practitioner.id}>
                        ...
                        <TableCell>
                          {practitioner.consultFeeItemId
                            ? (itemById.get(practitioner.consultFeeItemId)?.name ?? "—")
                            : "—"}
                        </TableCell>
                        <TableCell>
                          {practitioner.followUpFeeItemId
                            ? (itemById.get(practitioner.followUpFeeItemId)?.name ?? "—")
                            : "—"}
                        </TableCell>
                        <TableCell className="text-right">
                          <Button
      ...
      <DialogContent>
        ...
        <Form {...form}>
          <form noValidate onSubmit={submit} className="flex flex-col gap-4">
            ...
            />
            {/* Controlled, not registered: the item arrives from a query,

...
export function customerAgeYears(dateOfBirth: string, orgToday: string): number {
...
export function customerAgeLabel(
  dateOfBirth: string,
  dobEstimated: boolean,
  orgToday: string,
): string {
  const age = customerAgeYears(dateOfBirth, orgToday);
